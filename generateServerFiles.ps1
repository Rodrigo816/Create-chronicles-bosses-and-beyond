...
$MOD_BLACK_LIST="betterfpsdist*", "MapTooltip-forge*", "probejs*", "moreoverlays*", "MouseTweaks*", "oculus*", "EquipmentCompare*", "Prism*", "Boat-Item-View*", "tia-1.20*", "gpumemleakfix*", "LegendaryTooltips*", "Highlighter*", "Ding*", "AmbientSounds*", "modnametooltip*", "fancymenu*", "SimpleDiscordRichPresence*", "OverflowingBars*","ToolStats-Forge-*","AmbientSounds_FORGE*","SimpleDiscordRichPresence-forge-*","fancymenu_forge_*", "drippyloadingscreen_forge_*","melody_forge_*"
